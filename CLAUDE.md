...
- **URL** : https://nutriatlasreport.com/ (baseURL provisoire, domaine a confirmer/acheter avant mise en ligne reelle ; sinon utiliser l'URL GitHub Pages par defaut au moment du `/github-setup`)
...
- **Categories (DE / EN / FR / IT)** :
  - "Schoenheit und Haare" / "Beauty and Hair" / "Beaute et cheveux" / "Bellezza e capelli"
  - "Gewicht und Stoffwechsel" / "Weight and Metabolism" / "Poids et metabolisme" / "Peso e metabolismo"
  - "Schlaf und Energie" / "Sleep and Energy" / "Sommeil et energie" / "Sonno ed energia"
  - "Immunsystem" / "Immune System" / "Immunite" / "Sistema immunitario"
  - Note : noms de categories volontairement sans diacritiques (oe/ae/ue, sans accents) dans les 4 langues pour garantir des slugs d'URL previsibles (voir `removePathAccents = true` dans `hugo.toml`)
- **Auteur principal du site** : `laura-verdier` (specialiste sante/bien-etre/nutrition dans `data/authors.yaml`, traductions DE/IT ajoutees specifiquement pour ce site en plus des FR/EN d'origine)
